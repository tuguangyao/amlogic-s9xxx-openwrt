...
# git clone --depth 1 https://github.com/tuhaiyang/luci-app-vlmcsd.git packages/luci-app-vlmcsd
# git clone --depth 1 https://github.com/tuhaiyang/vlmcsd.git package/net/vlmcsd
